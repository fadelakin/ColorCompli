...
public class Compliments {
    ...
    public String mCompliments[] = {
            ...
            "I don't speak much English, but with you all I really need to say is gorgeous.",
    ...
    public String getCompliment() {
        ...
        int randomNum = numberGen.nextInt(mCompliments.length);

        compliment = mCompliments[randomNum];
